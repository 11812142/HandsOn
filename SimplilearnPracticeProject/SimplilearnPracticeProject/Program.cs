        ...
        { 
            ...
            switch (ss)
            {
                case 1:
                    ...
                    string textFile = "C:\\Users\\INDIA\\Desktop\\GitSimplilearnProject\\TextFile1.txt";
                    ...
                    // Write to file
                    File.WriteAllLines("C:\\Users\\INDIA\\Desktop\\GitSimplilearnProject\\TextFile2.txt", sorted2.Select(x => x.Key + "," + x.Value).ToArray());
                    ...
                    // Write to file
                    File.WriteAllLines("C:\\Users\\INDIA\\Desktop\\GitSimplilearnProject\\TextFile3.txt", sorted4.Select(x => x.Key + "," + x.Value).ToArray());
                ...
                case 2:
                    ...
                    string[] words = File.ReadAllText("C:\\Users\\INDIA\\Desktop\\GitSimplilearnProject\\TextFile1.txt").Split(' ');
