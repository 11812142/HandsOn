...
namespace ClassLibrary
{
    ...
    public static class curr
    {
        ...
        public static void current(this Extension obj)
        {
            Console.WriteLine("current balance " + obj.x);
        }
        public static void deposits(this Extension obj)
        {
        ...
        public static void withdraw(this Extension obj)
        {
        ...
        public static void total_balc(this Extension obj)
        {
    ...
    public static class sav
    {
        ...
        public static void savings(this Extension obj)
        {
            Console.WriteLine("saving balance" + obj.y);
        }
        public static void deposits1(this Extension obj)
        {
        ...
        public static void withdraw1(this Extension obj)
        {
        ...
        public static void total_balc1(this Extension obj)
        {
